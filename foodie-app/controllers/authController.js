...
exports.forgot = async (req, res) => {
    ...
    const resetURL = `http://${req.headers.host}/account/reset/${user.resetPasswordToken}`; // never include token on screen
    await mail.send({
        user,
...
exports.update = async (req, res) => {
    ...
    user.resetPasswordToken = undefined; //setting to undefined removes from mongodb
